    ...
    <div className="flex flex-col h-full bg-[#0a0e1a]">
            ...
            <div className="bg-[#111827] border border-[#1e293b] rounded-2xl rounded-tl-sm px-4 py-3">
              <div className="flex gap-1.5 items-center h-5">
                {[0, 1, 2].map((i) => (
                  <div
                    key={i}
                    className="typing-dot w-2 h-2 rounded-full bg-[#3b82f6]"
                  />
                ))}
              </div>
            </div>
      ...
      <div className="px-4 pb-4 shrink-0">
        ...
        <p className="text-[10px] text-[#334155] mt-1.5 text-center">
          Press <kbd className="px-1 py-0.5 bg-[#1e293b] rounded text-[#475569]">Enter</kbd> to send · Shift+Enter for new line
        </p>
      </div>
    </div>
  );
